const eventsData = [
    { id: 'test_now', date: "2026-02-18T00:00:00+03:00", preTime: "2026-02-17T18:44:00+03:00", title: "تجربة التنبيه 🔔", preMsg: "هذا تنبيه تجريبي للتأكد من عمل النظام الساعة 6:44 م", startMsg: "بدأ الحدث التجريبي" },
...
setInterval(() => {
    ...
    eventsData.forEach(ev => {
        ...
        // إذا كان الوقت الحالي هو وقت التنبيه (ضمن أول 60 ثانية)
